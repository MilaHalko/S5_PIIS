...
public static class ArrayExtensions
{
    ...
    public static void AddRow(this double[] arr, in Matrix mat, int row, double factor = 1)
    {
        for (int i = 0; i < arr.Length; i++)
        {
    ...
    public static void SubtractRow(this double[] arr, in Matrix mat, int row, double factor = 1)
    {
        for (int i = 0; i < arr.Length; i++)
        {
            arr[i] -= mat[row, i] * factor;
